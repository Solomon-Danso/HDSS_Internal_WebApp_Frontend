 ...
 const [RoleList, setRoleList] = useState([])
    ...
    const handlesubmit = async () => {
        ...
        let longt = ""
         ...
         try {
           ...
           formData.append("DestinationArrivalLatitude", latitude);
           formData.append("DestinationArrivalLongtitude", longtitude);
          ...
          Show.showLoading("Processing Data")
           ...
           const response = await fetch(apiServer + "DestinationArrival", {
             method: "POST",
             body: formData,
           });
  ...
  return (
    ...
    <NewStudentListCard>
     ...
     {
   checkRole("SuperAdmin")|| checkRole("Destination")|| checkRole("HeadTeacher")?(<>
