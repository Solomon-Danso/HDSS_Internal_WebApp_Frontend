...
import  {AddAnnoucementCard}  from './AddAnnouncementCardP'
...
const StudentInfo = () => {
      ...
      useEffect(() => {
        if(userInfo.staffID){
            const URL=`api/LMS/GetannoucementForPTA`
    ...
    const URL=`api/LMS/AddannoucementForPTA?SID=${userInfo.staffID}`
...

{
  ...
  <AboutHeader2
     ...
     >
       {dropper?"Minimize":"Add PTA Annoucement"}
     </AboutHeader2> <br/>
