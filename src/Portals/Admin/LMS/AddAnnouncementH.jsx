...
import  {AddAnnoucementCard}  from './AddAnnouncementCardH'
...
const StudentInfo = () => {
      ...
      useEffect(() => {
        if(userInfo.staffID){
            const URL=`api/LMS/GetannoucementForHOD`
    ...
    const URL=`api/LMS/AddannoucementForHOD?SID=${userInfo.staffID}`
...

{
  ...
  <AboutHeader2
     ...
     >
       {dropper?"Minimize":"Add HOD Annoucement"}
     </AboutHeader2> <br/>
