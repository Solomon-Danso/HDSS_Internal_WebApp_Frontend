...
import  {AddAnnoucementCard}  from './AddAnnoucementCardT'
...
const StudentInfo = () => {
      ...
      useEffect(() => {
        if(userInfo.staffID){
            const URL=`api/LMS/GetannoucementForTeacher`
    ...
    const URL=`api/LMS/AddannoucementForTeacher?SID=${userInfo.staffID}`
...

{
  ...
  <AboutHeader2
     ...
     >
       {dropper?"Minimize":"Add Teacher Annoucement"}
     </AboutHeader2> <br/>
