...
const navigate = useNavigate()
  ...
  useEffect(() => {
    const URL = `api/StudentApp/Slide?SID=${userInfo.studentId}&ClassName=${userInfo.level}&Subject=${subject}`;
...
useEffect(() => {
  ...
  const fetchSearchResults = async () => {
    ...
    const URL = `api/Admin/StudentSearchSlide?searchTerm=${searchTerm}&ClassName=${userInfo.level}`
    try {
...
const Counter = async (server,id) => {
  ...
  const URL = `api/StudentApp/SingleSlide?SID=${userInfo.studentId}&Id=${id}`;
